(() => {
  const messages = {
    "zh-TW": {
      ...
      screenshotPrivacyNotice: "預設關閉。截圖可能包含姓名與郵件資料；啟用後只會在查詢錯誤時，由查詢頁在本機建立畫面，不需要 Chrome 除錯權限。",
    ...
    en: {
      ...
      screenshotPrivacyNotice: "Off by default. A screenshot may contain names and mail details. When enabled, the query page creates the image locally only after a query error; no Chrome debugger permission is required.",
