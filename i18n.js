(() => {
  const messages = {
    "zh-TW": {
      ...
      clearSeen: "清除已看過郵件紀錄",
      clearLogs: "清除查詢紀錄",
      backupDiagnosticsTitle: "備份與診斷",
      backupDescription: "設定備份包含收件人、排程、通知、語言與原始程式資料夾備忘，不包含學校帳號密碼。",
      backupSettings: "備份全部設定",
      importSettings: "匯入設定",
      captureScreenshotOnError: "查詢錯誤時保存最近一次錯誤畫面截圖",
      screenshotPrivacyNotice: "預設關閉。截圖可能包含姓名與郵件資料；啟用時 Chrome 會詢問可選的除錯權限，僅用於擷取長庚郵件查詢頁。",
      downloadDiagnosticsJson: "產生診斷 JSON",
      downloadDiagnosticsZip: "產生診斷 ZIP",
      diagnosticsDescription: "診斷報告包含外掛與 Chrome 版本、查詢欄位狀態、錯誤紀錄及最近查詢結果；ZIP 會在有截圖時一併加入。下載後會詢問是否使用系統預設郵件程式聯絡開發者。",
      diagnosticsPrivacyNotice: "診斷內容可能包含收件人姓名、查詢結果與本機路徑，寄送前請先確認內容。",
      authorTitle: "作者資訊",
      authorEmail: "Email",
      authorWebsite: "個人網頁",
      refresh: "重新整理",
    ...
    en: {
      ...
      backupDiagnosticsTitle: "Backup and diagnostics",
      backupDescription: "The settings backup includes recipients, schedules, notifications, language, and the source-folder note. It never contains university credentials.",
      backupSettings: "Back up all settings",
      importSettings: "Import settings",
      captureScreenshotOnError: "Save the most recent query-page screenshot when an error occurs",
      screenshotPrivacyNotice: "Off by default. A screenshot may contain names and mail details. Chrome requests the optional debugger permission only when this feature is enabled, and it is used only for the CGU postal query page.",
      downloadDiagnosticsJson: "Generate diagnostic JSON",
      downloadDiagnosticsZip: "Generate diagnostic ZIP",
      diagnosticsDescription: "The report contains extension and Chrome versions, query-field status, error logs, and the latest query result. The ZIP also includes the screenshot when available. After downloading, you can open your default email application to contact the developer.",
      diagnosticsPrivacyNotice: "Diagnostics may contain recipient names, query results, and a local folder path. Review the contents before sending.",
      authorTitle: "Author",
      authorEmail: "Email",
