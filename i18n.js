(() => {
  const messages = {
    "zh-TW": {
      ...
      diagnosticsDescription: "診斷報告包含外掛與 Chrome 版本、查詢欄位狀態、錯誤紀錄及最近查詢結果；ZIP 會在有截圖時一併加入。",
    ...
    en: {
      ...
      diagnosticsDescription: "The report contains extension and Chrome versions, query-field status, error logs, and the latest query result. The ZIP also includes the screenshot when available.",
